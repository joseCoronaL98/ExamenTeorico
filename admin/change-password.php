...
<html lang="es-MX">
    <head>
        ...
        <title>Noticias | Cambiar Password</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Canbiar Password</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Cambiar Password </b></h4>
                                    <hr />
...
<strong>¡Guardado!</strong> <?php echo htmlentities($msg);?>
</div>
<?php } ?>
...
<label class="col-md-4 control-label">Password Anterior</label>
<div class="col-md-8">
...
<div class="form-group">
<label class="col-md-4 control-label">Nuevo Password</label>
<div class="col-md-8">
