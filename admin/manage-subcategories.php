...
<html lang="es-MX">
    <head>
        ...
        <title> Noticias | Administrar subcategorías</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Administrar subcategorías</h4>
...
<td colspan="7" align="center"><h3 style="color:red">Sin registros</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Subcategoria eliminadas</h4>
