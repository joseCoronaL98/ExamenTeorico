...
<html lang="es">
    <head>
        ...
        <title>Noticias | Editar usuario</title>
...
<strong>Ocurrio un error!</strong> <?php echo htmlentities($error);?></div>
<?php } ?>
...
?>
            ...
            <input type="text" class="form-control" value="<?php echo htmlentities($row['AdminEmailId']);?>" name="emailid" required>
             ...
             <div class="form-group">
            <label class="col-md-2 control-label">Creado</label>
            <div class="col-md-10">
            <input type="text" class="form-control" value="<?php echo htmlentities($row['CreationDate']);?>" name="cdate" readonly>
             ...
             <div class="form-group">
            <label class="col-md-2 control-label">Actualizacion</label>
            <div class="col-md-10">
